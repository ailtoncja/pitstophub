...
const DRIVER_BIOS: Record<string, { pt: string; en: string }> = {
  ...
  'f1:fittipaldi': {
    pt: 'Emerson Fittipaldi estreou na Fórmula 1 pela Lotus em 1970 e, após a morte de Jochen Rindt, assumiu o papel de piloto principal ainda naquela temporada. Foi campeão mundial em 1972, aos 25 anos — o mais jovem da história até então — e repetiu o título em 1974, já na McLaren. Soma 14 vitórias, 35 pódios e 6 poles em 144 largadas. Depois da F1, venceu as 500 Milhas de Indianápolis em 1989 e 1993 e o campeonato da CART em 1989, um dos poucos a ser campeão mundial e vencer em Indianápolis.',
    en: 'Emerson Fittipaldi made his Formula 1 debut with Lotus in 1970 and, after Jochen Rindt\'s death, became the team\'s lead driver that same season. He won the World Championship in 1972, aged 25 — the youngest champion in history at the time — and took the title again in 1974 with McLaren. He scored 14 wins, 35 podiums and 6 poles in 144 starts. After F1 he won the Indianapolis 500 in 1989 and 1993 and the CART championship in 1989, one of the few men to be both a world champion and an Indy 500 winner.',
  },
  'f1:piquet': {
    pt: 'Nelson Piquet estreou na Fórmula 1 em 1978 e se consolidou na Brabham, onde conquistou os títulos de 1981 e 1983. Em 1987, já na Williams, faturou o terceiro mundial. Soma 23 vitórias, 60 pódios e 24 poles em 204 largadas. Conhecido pelo estilo analítico e pela rivalidade com Nigel Mansell, deixou a categoria em 1991 e permanece um dos três brasileiros campeões mundiais de Fórmula 1.',
    en: 'Nelson Piquet made his Formula 1 debut in 1978 and established himself at Brabham, where he won the 1981 and 1983 titles. In 1987, by then with Williams, he claimed a third World Championship. He scored 23 wins, 60 podiums and 24 poles in 204 starts. Known for his analytical style and his rivalry with Nigel Mansell, he left the category in 1991 and remains one of three Brazilian Formula 1 world champions.',
  },
  'f1:senna': {
  ...
  'f1:rubens': {
    pt: 'Rubens Barrichello estreou na Fórmula 1 pela Jordan em 1993 e passou 19 temporadas no grid — Jordan, Stewart, Ferrari, Honda, Brawn e Williams. Na Ferrari, ao lado de Michael Schumacher, venceu sua primeira corrida em Hockenheim em 2000, largando em 18º, e foi vice-campeão mundial em 2002 e 2004. Em 2009, pela Brawn, venceu em Valência e em Monza e terminou o mundial em 3º. Soma 11 vitórias, 68 pódios e 14 poles em 322 largadas, recorde da categoria na época. Depois da F1, correu na IndyCar e foi campeão da Stock Car em 2014 e 2022.',
    en: 'Rubens Barrichello made his Formula 1 debut with Jordan in 1993 and spent 19 seasons on the grid — Jordan, Stewart, Ferrari, Honda, Brawn and Williams. At Ferrari, alongside Michael Schumacher, he took his first win at Hockenheim in 2000 from 18th on the grid and finished championship runner-up in 2002 and 2004. In 2009, with Brawn, he won in Valencia and at Monza and finished 3rd in the championship. He scored 11 wins, 68 podiums and 14 poles in 322 starts, a record at the time. After F1 he raced in IndyCar and won the Stock Car title in 2014 and 2022.',
  },
  'f1:massa': {
    pt: 'Felipe Massa estreou na Fórmula 1 pela Sauber em 2002 e chegou à Ferrari em 2006, onde venceu pela primeira vez na Turquia e se tornou o primeiro brasileiro a vencer em Interlagos desde Senna, em 1993. Em 2008, faturou seis GPs e perdeu o título para Lewis Hamilton por um ponto, na última volta da última corrida. Em 2009, sofreu um grave acidente nos treinos da Hungria e ficou de fora do resto da temporada. Depois de oito anos na Ferrari, encerrou a carreira na Williams em 2017. Soma 11 vitórias, 41 pódios e 16 poles em 269 largadas.',
    en: 'Felipe Massa made his Formula 1 debut with Sauber in 2002 and joined Ferrari in 2006, where he took his first win in Turkey and became the first Brazilian to win at Interlagos since Senna in 1993. In 2008 he won six Grands Prix and lost the title to Lewis Hamilton by one point, on the last lap of the last race. In 2009 he suffered a serious qualifying accident in Hungary and missed the rest of the season. After eight years at Ferrari he ended his F1 career with Williams in 2017. He scored 11 wins, 41 podiums and 16 poles in 269 starts.',
  },
  'f1:bottas': {
...
export default function App({ currentUser, onLogout, onLoginRequest }: AppProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-1 min-w-0 flex flex-col xl:self-start">
                                    ...
                                    <div className="p-6">
                                      <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center sm:justify-between gap-3 mb-4">
                                        ...
                                        <button
                                          ...
                                          className={cn(
                                            "px-3 py-1.5 text-[10px] font-black uppercase tracking-widest border transition-colors shrink-0 self-start sm:self-auto",
